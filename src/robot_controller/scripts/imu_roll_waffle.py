...
class RobotController:
    ...
    def imu_callback(self, data):
        ...
        self.linear_velocity = data.linear_acceleration.x
    ...
    def get_robot_position_imu(self):
        self.x += self.linear_velocity * math.cos(self.theta)
        self.y += self.linear_velocity * math.sin(self.theta)
        self.theta += self.angular_velocity
        rospy.loginfo(f"*** Position du robot (IMU) mise à jour - x: {self.x}, y: {self.y}, theta: {self.theta}")
